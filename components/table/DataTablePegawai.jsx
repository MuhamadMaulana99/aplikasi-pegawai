...
const DataTablePegawai = ({ setData }) => {
  const { data, isLoading, isError, tambahPegawai, editPegawai, hapusPegawai } =
    usePegawai();
  ...
  const handleSave = () => {
    if (selectedRow) {
      editPegawai.mutate(
        { id: selectedRow.id_pegawai, ...formData },
        { onSuccess: handleCloseDialog }
      );
    } else {
      tambahPegawai.mutate(formData, { onSuccess: handleCloseDialog });
    }
  };

  const handleDelete = () => {
    hapusPegawai.mutate(selectedRow.id_pegawai, {
...
export default DataTablePegawai;
